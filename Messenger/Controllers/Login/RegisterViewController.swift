...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: {[weak self] exist in
            ...
            guard !exist else {
                // user already exists
                strongSelf.errorUserLoginError(message: "Looks like a user account for that email address already exists")
                return
            }
    ...
    func errorUserLoginError(message: String = "Please enter all information to creat a new account.") {
