...
extension DatabaseManager {
    ...
    /// Create a new cinveration with target usrt email and first message sent
    ...
    /// Fetches amd returns all conversations for the user with passed in email
    public func getAllConversaions(for email: String, completion: @escaping (Result<String, Error>) -> Void) {
        
    }
    
    /// Gets a;; messages for a given conversation
